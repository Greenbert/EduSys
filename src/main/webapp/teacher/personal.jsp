...
<div id="page" class="container">
    <div id="header">
        ...
        <div id="menu">
            <ul>
                <li class="current_page_item"><a href="personal.jsp">教师信息</a></li>
    ...
    <div id="main">
        ...
        <div class="infoT">
            <div class="picture">
                <img src="../userImg/<%=teacher.getId()%>.jpeg" class="personalImg" onerror="this.src='../userImg/default.jpeg';this.onerror = 'null'"><br><br><br>
                <form action="../upload_teacherImg" method="post" enctype="multipart/form-data" class="imgForm">
