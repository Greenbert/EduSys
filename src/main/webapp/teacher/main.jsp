    ...
    <div id="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li class="current_page_item"><a href="../one_page_student">学籍管理</a></li>
                ...
                %>
                        <tr>
                            <form method="post" action="../update_student">
                                ...
                                <td><input type="submit" class="update-btn" value="修改">&nbsp;<a class="btnDo"
                                                                                           onclick="return confirm('确定要删除吗?');"
                                                                                           href=<%="'../delete_student?id=" + stu.getId() + "'"%>>删除</a>&nbsp;&nbsp;<a class="btnDo" href="../one_page_score?id=<%=stu.getId()%>">查看成绩</a>
                                </td>
                            </form>
                        </tr>
                <%
...
<div id="add-dialog" title="添加学生信息">
    <form id="add-form" method="post">
        ...
        入学日期:<br><input name="school_date" type="month" style="width: 190px">
        <hr>
