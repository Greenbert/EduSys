...
<div class="main">
    <form role="form" action="sendCode.jsp" method="post">
        <div class="form-group" align="center">
            ...
            <input type="submit" class="btn btnNext btn-success " value="下一步">
            <input type="button"  class="btn btnCancel btn-info" value="取消" style="margin-left: 20px" onclick="window.location.href='login.jsp'">
        </div>
    </form>
</div>
